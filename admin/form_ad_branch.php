...
<body id="page-top">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          ...
          <form action="save_branch.php" method="post" enctype="multipart/form-data">
            <div class="row">
              <div class="col-lg-12">
                <!-- name -->
                <div class="card mb-4">
                  ...
                  <div class="row card-body">
                    <div class="col">
                      ...
                      <div class="form-group">
                        <label for="name_th_branch">ชื่อ ไทย</label>
                        <input type="text" class="form-control" id="name_th_branch" name="name_th_branch" placeholder="ชื่อ th">
                      </div>
                    </div>
                    <div class="col">
                      <div class="form-group ">
                        <label for="name_en_branch">ชื่อ อังกฤษ</label>
                        <input type="text" class="form-control" id="name_en_branch" name="name_en_branch" placeholder="ชื่อ en">
                      </div>
  ...
  <script>
    $(document).ready(function() {
      ...
      $('#start_date_branch').datepicker({
        format: 'dd/mm/yyyy',
        autoclose: true,
        todayHighlight: true
      });

      $('#end_date_branch').datepicker({
        format: 'dd/mm/yyyy',
        autoclose: true,
        todayHighlight: true
      });
